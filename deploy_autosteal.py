...
try:
    ...
    print("[+] auto steal feature added:")
    print("  - added checkbox in builder UI")
    print("  - connected to backend config generation")
    print("  - users can now enable/disable auto steal on first run")
