...
public class FormReverseTunnel : FormMaterial
{
	...
	public FormReverseTunnel()
	{
		InitializeComponent();
	}

	private void FormReverseTunnel_Load(object sender, EventArgs e)
	{
		if (parrent != null)
		{
			Text = "Tunnel [" + parrent.Hwid + "]";
		}
	}
	...
	private void switchStart_CheckedChanged(object sender, EventArgs e)
	{
		...
		if (switchStart.Checked)
		{
			...
			try
			{
				...
				parrent.Send(new object[3] { "Plugin", "ReverseTunnel", pluginData });
				txtClientPort.Enabled = false;
				txtServerPort.Enabled = false;
				Text = "Tunnel [" + parrent.Hwid + "] - Running";
				return;
			}
			catch (Exception ex)
			{
		...
		try
		{
			...
			parrent.Send(new object[3] { "Plugin", "ReverseTunnel", pluginData2 });
			txtClientPort.Enabled = true;
			txtServerPort.Enabled = true;
			Text = "Tunnel [" + parrent.Hwid + "] - Stopped";
		}
		catch (Exception ex2)
		{
	...
	public void UpdateStatus(string status)
	{
		if (base.InvokeRequired)
		{
			Invoke((MethodInvoker)delegate
			{
				if (parrent != null)
				{
					Text = "Tunnel [" + parrent.Hwid + "] - " + status;
				}
				else
				{
					Text = "Tunnel - " + status;
	...
	private void InitializeComponent()
	{
		...
		this.labelClient.Location = new System.Drawing.Point(159, 18);
		...
		this.txtClientPort.BorderColor = System.Drawing.Color.FromArgb(192, 0, 192);
		this.txtClientPort.BorderFocusColor = System.Drawing.Color.Magenta;
		...
		this.txtClientPort.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
		this.txtClientPort.Location = new System.Drawing.Point(220, 14);
		...
		this.labelServer.Location = new System.Drawing.Point(448, 18);
		...
		this.txtServerPort.BorderColor = System.Drawing.Color.FromArgb(192, 0, 192);
		this.txtServerPort.BorderFocusColor = System.Drawing.Color.Magenta;
		...
		this.txtServerPort.ForeColor = System.Drawing.Color.FromArgb(64, 64, 64);
		this.txtServerPort.Location = new System.Drawing.Point(514, 14);
		...
		base.Name = "FormReverseTunnel";
		this.Text = "Tunnel";
		base.Load += new System.EventHandler(FormReverseTunnel_Load);
